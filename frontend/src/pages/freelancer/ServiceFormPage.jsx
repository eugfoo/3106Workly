								...
								<div>
									<label className="block text-sm font-medium text-gray-700 mb-1">
										...
										<span className="text-xs text-gray-500">
											Enter search tags you feel your clients will use when looking for your
											service
										</span>
									</label>
									<input
							...
							<div className="space-y-4 md:space-y-6">
								<div>
									<label className="block text-sm font-medium text-gray-700 mb-1">
										...
										<br />
										<span className="text-xs text-gray-500">
											Help clients provide information about what you need to get started on their
											order
										</span>
									</label>
									<textarea
									...
									<p className="text-xs text-gray-500 mt-2">
										These questions will be fed into our AI model and regenerated as prompts for
										your clients
									</p>
								</div>
								<div>
						...
						{currentStep === 4 && (
							<div className="space-y-4 md:space-y-6">
								<div className="text-center">
									<h2 className="text-xl font-bold">Ready to publish your service?</h2>
									<p className="text-gray-500 mt-2">
										Review all information before publishing. Once published, your service will be
